...
class StudentLinkTB
{
	...
	public:	
           ...
           POSITION AddHead(StudentNode stunode);
			...
			const StudentNode* FindByNameReturnNode(CString _name) const;
			StudentNode* FindByNameReturnNode(CString _name);
			const POSITION FindByNameReturnPosition(CString _name) const;
			POSITION FindByNameReturnPosition(CString _name);

			const StudentNode* FindByStunumReturnNode(CString _stunum) const;
			StudentNode* FindByStunumReturnNode(CString _stunum);
			const POSITION FindByStunumReturnPosition(CString _stunum) const;
			POSITION FindByStunumReturnPosition(CString _stunum);
};
